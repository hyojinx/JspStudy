 ...
 * Generated at: 2023-04-14 04:06:18 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp._17UseApi;
...
public final class SearchMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>네이버 검색 API 사용</title>\r\n");
      out.write("<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js\"></script>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("// [검색 요청] 버튼 클릭 시 실행할 메서드를 정의합니다.\r\n");
      out.write("$(function() {\r\n");
      out.write("    $('#searchBtn').click(function() {\r\n");
      out.write("      $.ajax({\r\n");
      out.write("        url : \"../NaverSearchAPI.do\",  // 요청 URL\r\n");
      out.write("        type : \"get\",                  // HTTP 메서드\r\n");
      out.write("        data : {                       // 매개변수로 전달할 데이터\r\n");
      out.write("            keyword : $('#keyword').val(),                   // 검색어\r\n");
      out.write("            startNum : $('#startNum option:selected').val()  // 검색 시작 위치\r\n");
      out.write("        },\r\n");
      out.write("        dataType : \"json\",      // 응답 데이터 형식\r\n");
      out.write("        success : sucFuncJson,  // 요청 성공 시 호출할 메서드 설정\r\n");
      out.write("        error : errFunc         // 요청 실패 시 호출할 메서드 설정\r\n");
      out.write("      });\r\n");
      out.write("    });\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("// 검색 성공 시 결과를 화면에 뿌려줍니다.\r\n");
